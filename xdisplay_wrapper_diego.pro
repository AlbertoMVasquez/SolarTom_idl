...
r0A=[1.105]
xdisplay,dir='/data1/work/dem/',file='Ne_CR2198_DEMT-AIA_H1-L.7.9.9_r3D_reduced',nr= 26,nt=90,rmin=1.00,rmax=1.26,r0A=r0A,win=0,titulo='EUV:Ne [cm!U-3!N]',minA=1.,maxA=2.45e8,$
...
xdisplay,dir='/media/Data1/data1/tomography/bindata/',file='x_KCOR.CR2198.13imgs-reduced.bf2.ri1.05.ro2.25_Inst_1.09_2.00_120_90_180_dropneg_r3D_l1e-4',nr= 120,nt=90,rmin=1.05,rmax=2.25,$
         r0A=r0A,win=0,titulo='WL:Ne [cm!U-3!N]',minA=minima,maxA=maxima,box_lat=[-40.,0.,70.,80.],box_lon=[230.,320.,180.,360.]

r0A=[1.105,1.205]
xdisplay,dir='/data1/work/dem/',file='Ne_CR2208_l1.0.60.90_h1_r3D_reduced',nr= 30,nt=90,rmin=1.0,rmax=1.30,$
         r0A=r0A,win=0,titulo='EUV:Ne [cm!U-3!N]',minA=[0.5,0.5],maxA=[1.2,0.8]*1.e8

r0A=[1.105,1.205]
xdisplay,dir='/data1/work/dem/',file='Ne_CR2208_l1.0.60.90_h1_r3D_reduced',nr= 30,nt=90,rmin=1.0,rmax=1.30,$
         r0A=r0A,win=0,titulo='EUV:Ne [cm!U-3!N]',minA=[0.5,0.5],maxA=[2.e8,1.1e8],box_lat=[-40.,0.,70.,80.],box_lon=[230.,320.,180.,360.]
...
xdisplay,dir='/media/Data1/data1/tomography/bindata/',file='x_KCOR.CR2208.13imgs.bf2.ri1.05.ro2.25_Inst_1.09_2.00_120_90_180_dropneg_r3D_l6.e-5',nr= 120,nt=90,rmin=1.05,rmax=2.25,$
         r0A=r0A,win=0,titulo='WL:Ne [cm!U-3!N]',minA=[0.5,0.5],maxA=[2.e8,1.1e8];,box_lat=[-40.,0.,70.,80.],box_lon=[230.,320.,180.,360.]
