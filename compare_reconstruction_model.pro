...
compare_reconstruction_model,orbit= 1,ir=07,filename='Orbit_01_4.8Rs.gif'
compare_reconstruction_model,orbit= 1,ir=13,filename='Orbit_01_8.6Rs.gif'
...
'x_wisprIO.512.CircularOrbit01.60images_3regmat_l1e-5']
 ...
 map7 = reform(Ne_wIO_O24_3regmat(ir,*,*))
 endif
